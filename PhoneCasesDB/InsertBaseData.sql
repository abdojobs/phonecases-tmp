...
BEGIN
	...
	insert into PhoneCases.pc.Users(Id,Name,PhoneNumber) values (0,'Alla','0');
	...
	insert into PhoneCases.pc.Users(Id,Name,PhoneNumber) values (4,'Emulator','000000000000000');
	SET IDENTITY_INSERT pc.Users OFF
	
	SET IDENTITY_INSERT pc.Locations ON
	insert into PhoneCases.pc.Locations(Id,Name) values (0,'Okänd');
	...
	insert into PhoneCases.pc.CompanyTypes(Id,Name) values (0,'Okänd');
	...
	insert into PhoneCases.pc.Companies(Id,Name,CompanyTypesId,LocationId) values (0,'Okänd',0,0);
	...
	insert into PhoneCases.pc.Customers(Id,Name,CompanyId,PhoneNumber) values (0,'Okänd',1,'0');
